...
define('curtains/controls',['proscenium'], function (Proscenium) {
    return {
...
define('curtains/splash',['proscenium'], function (Proscenium) {
    return {
...
define('roles/conductor',['proscenium'], function (Proscenium) {
    return {
        init: function () {
            this.set('radius', 20);
            this.set('speed', 120);
...
define('roles/passenger',['proscenium'], function (Proscenium) {
    return {
        init: function () {
            this.set('radius', 20);
...
require([
    ...
    require([
        ...
        window.conductor = Proscenium.actors.conductor;
    });
});
